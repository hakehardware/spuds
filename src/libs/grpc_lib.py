...
from src.generated_code.spacemesh.v1 import activation_pb2_grpc
from src.generated_code.spacemesh.v1 import admin_pb2_grpc
from src.generated_code.spacemesh.v1 import node_pb2_grpc
from src.generated_code.spacemesh.v1 import smesher_pb2_grpc
from src.generated_code.spacemesh.v1 import debug_pb2_grpc
from src.generated_code.spacemesh.v1 import global_state_pb2_grpc
from src.generated_code.spacemesh.v1 import mesh_pb2_grpc

class CheckOnline(object):
    @staticmethod
    def check_online(ip_address_with_port):
        
        channel = grpc.insecure_channel(ip_address_with_port)
        try:
            grpc.channel_ready_future(channel).result(timeout=1)
            return True
        except FutureTimeoutError:
            return False
            #logger.error(f'Error checking if grpc is online. Error: {e}')
